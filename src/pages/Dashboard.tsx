    ...
    <div className="min-h-screen w-full bg-[#f4f4f4] flex flex-col items-center justify-center p-6 sm:p-12">
      <div className="w-full max-w-6xl">
        <header className="mb-12 text-center">
          <h1 className="text-4xl font-bold text-[#333333] tracking-tight mb-4">Label Proofing Dashboard</h1>
        ...
        >
          ...
          <h2 className="text-xl font-bold text-[#333333]">Compare Only</h2>
        ...
        >
          ...
          <h2 className="text-xl font-bold text-[#333333]">Form + Compare</h2>
          <p className="text-sm text-[#666666]">
        ...
        >
          ...
          <h2 className="text-xl font-bold text-[#333333]">Form vs New Version</h2>
          <p className="text-sm text-[#666666]">
